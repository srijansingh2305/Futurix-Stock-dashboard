...
const lineData = [
  { date: "Apr 15", price: 89.5 },
  { date: "Apr 16", price: 91.2 },
  { date: "Apr 17", price: 92.96 },
  { date: "Apr 18", price: 91.4 },
  { date: "Apr 19", price: 91.9 },
];
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-4">
            ...
            />
            <div>
              <div className="text-xl font-semibold">AAPL <span className="text-gray-400 font-normal">Apple Inc.</span></div>
